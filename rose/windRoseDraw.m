function [] = windRoseDraw(SwanFileFolderPath)
...
for year = 1:length(filePaths)
    windx = wp_readMat(filePaths{year},2027,2);%"E:\张明阳\项目\SWAN_Taiwan_result\te_ST6_S6_2022.mat"
...
direc = {m1D,m2D,m3D,m4D,direction};
spee = {m1S,m2S,m3S,m4S,wind};
